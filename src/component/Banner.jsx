...
const Banner = () => {
    return (
        <div className="px-6">
            ...
            <div className="mt-20  about-me-container md:flex lg:flex gap-6 justify-content-around align-items-center ">
                <div className="about-me-text space-y-4">
                    ...
                    <div className=" flex text-red-600 font-bold text-4xl gap-4 px-6">
